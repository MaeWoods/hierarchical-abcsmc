...
def distance(data1, data2, parameters, model):
		...
		alldist = -1
		sig1 = numpy.sum([ data1[:,0], data1[:,1], data1[:,3] ], axis=0 ) * 0.0285714857
		sig2 = numpy.sum([ data1[:,4], data1[:,5], data1[:,32] ], axis=0 ) * 0.0285714857
		sig3 = numpy.sum([ data1[:,7], data1[:,8], data1[:,33] ], axis=0 ) * 0.0285714857
		sig4 = numpy.sum([ data1[:,10], data1[:,11], data1[:,29] ], axis=0 ) * 0.0285714857
		sig5 = numpy.sum([ data1[:,13], data1[:,14] ], axis=0 ) * 0.0285714857
		sig6 = numpy.sum([ data1[:,16], data1[:,17] ], axis=0 ) * 0.0285714857
		sig7 = numpy.sum([ data1[:,19], data1[:,20] ], axis=0 ) * 0.0285714857
		sig8 = numpy.sum([ data1[:,22], data1[:,23], data1[:,24] ], axis=0 ) * 0.0285714857
