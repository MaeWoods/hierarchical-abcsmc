...
################ compute the pdf of truncated normal distribution
def getPdfTruncnormal(mean,sigm,parameter):
    x = stats.truncnorm.pdf(parameter, (0 - mean)/sigm, (1000000 - mean)/sigm, loc=mean, scale=sigm)
    return x
